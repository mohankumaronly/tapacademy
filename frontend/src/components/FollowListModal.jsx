...
import { X, Users, UserPlus, MapPin, Briefcase, ChevronRight } from "lucide-react";
            ...
            {(!users || users.length === 0) ? (
              ...
              <div className="divide-y divide-gray-50">
                {users.map((user, index) => {
                  ...
                  const firstName = user.firstName || user.userId?.firstName || "User";
                  const lastName = user.lastName || user.userId?.lastName || "";
                  const fullName = `${firstName} ${lastName}`.trim();
                  const avatarUrl = user.avatarUrl || user.userId?.avatarUrl || "/avatar-placeholder.png";
                    ...
                    >
                      <div className="flex items-center gap-4 px-6 py-4 hover:bg-gray-50/80 cursor-pointer transition-all">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {user.headline && (
                            <p className="text-sm text-gray-500 truncate mt-0.5">{user.headline}</p>
                          )}
